class DropboxController{
    ...
    constructor(){
        ...
        this.onselecttionchange = new Event('selectionchange');
        ...
        this.initEvents();//Chama as funções iniciais
        this.connectFirebase()//Faz a conexão com o Firebase 

        this.openFolder()//Abre as pastas inclusive a raiz
    ...
    connectFirebase(){
        ...
        var firebaseConfig = {
            apiKey: "AIzaSyCQc4zSrYX3SIIkv1si5pWH1x7UKUxx6Lo",
            authDomain: "dropbox-clone-72292.firebaseapp.com",
            databaseURL: "https://dropbox-clone-72292.firebaseio.com",
            projectId: "dropbox-clone-72292",
            storageBucket: "dropbox-clone-72292.appspot.com",
            messagingSenderId: "346845198720",
            appId: "1:346845198720:web:b6633b5d9fc37dd8"
        };
        // Initialize Firebase
    ...
    //Traz todos os arquivos selecionados
    getSelection(){
        return this.listFilesEl.querySelectorAll(".selected");
    }

    //Metodos iniciais, disparados pelo usuario na interface
    initEvents(){
        ...
        //Para mostrar botao de excluir, renomear etc. De acordo com arquivos selecionados
        ...
        //Quando clicar no botão Enviar arquivo
        ...
        //Método para acompanhar o envio de arquivos(Mostra a barra de progresso)
    ...
    //Quando o upload for completado , vai fechar a barra de upload, etc.
    uploadComplete(){
    ...
    //Para saber quando mostrar a barra de progresso ou não
    modalShow(show = true){
        
        this.snackModalEl.style.display = (show) ? 'block': 'none';
    }

    //FAz as configurações do Ajax
    ajaxUtil(url, method = 'GET', formData = new FormData(), onprogress = function(){}, onloadstart = function(){}){
    ...
    //Recebe e trata os arquivos quando for feito o upload
    uploadTask(files){
    ...
    //Remove um ou mais arquivos do disco e do servidor
    removeTask(){
        let promises = [];//Recebe as promessas(referencia de arquivos)

        this.getSelection().forEach(li=>{

            let file = JSON.parse(li.dataset.file); //Pega os dados do arquivo que está no data-set
    ...
    //Para remover pastas e seus arquivos (metodo recursivo), Chamada no removeTask() 
    ...
    //Para Remover arquivos Chamada no removeTask() e removeFolderTask()
    removeFile(ref, name){
    ...
    //Controla os dados na barra de progresso em tempo real
    ...
    //Transforma milissegundos em horario legivel para pessoas com o QI do Jovi
    ...
    //Vai pegar a vizualização dos arquivos/ interface do arquivo
    ...
    //Para pegar o icone de acordo com o arquivo
    ...
    //Ler os arquivos do BD(firebase)
    readFiles(){
    ...
    //Abre uma pasta quando ela for clicada
    openFolder(){
    ...
    //Renderiza a Navegação de pastas Ex: Dropbox > Musicas
    renderNav(){
    ...
    //Inicia os eventos do arquivos que está no Dropbox
    initEventsLi(li){

        //Quando alguém da um clique no arquivo ou pasta
        li.addEventListener('click', event=>{
            ...
            if(event.shiftKey){
                ...
                if(firstLi){
                    ...
                    this.listFilesEl.dispatchEvent(this.onselecttionchange);
                    return true;
                }
            }
        ...
        //Quando alguém da dois cliques no arquivo ou pasta
